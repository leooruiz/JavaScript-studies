...
var comprimento; //var representa a variável qde escopo global, então funciona em qualquer parte do código (exceto var criadas dentro de funções), o que pode gerar possíveis problemas em relação à lógica da aplicação.
